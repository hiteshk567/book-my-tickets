...
import NewShow from "./theatres/pages/new-show";
import MyTickets from "./theatres/pages/my-tickets";
import NewTheater from "./theatres/pages/new-theatre";
import AdminPage from "./users/pages/admin-page";
import ShowSeats from "./theatres/pages/show-seats";
  ...
  if (token) {
    routes = (
      <Switch>
        ...
        <Route path="/:theaterId/newShow" exact>
          <NewShow />
        </Route>

        <Route path="/theater/:showId/seats" exact>
          <ShowSeats />
        </Route>

        <Route path="/newTheater" exact>
          <NewTheater />
        </Route>
